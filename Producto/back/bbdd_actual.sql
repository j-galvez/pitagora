...
--
-- Current Database: `postventa_test`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `postventa_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `categorias` VALUES (1,'Instalaciones Sanitarias','Grifería','Problemas con llaves, monomandos y sellos de silicona','2026-05-04 01:17:04'),(2,'Instalaciones Sanitarias','Tuberías','Filtraciones en PVC, PPR o descargas','2026-05-04 01:17:04'),(3,'Terminaciones','Pintura','Descascaramiento, burbujas o manchas de humedad','2026-05-04 01:17:04'),(4,'Terminaciones','Cerámicas','Palmetas sueltas, fragüe desprendido o trizaduras','2026-05-04 01:17:04'),(5,'Electricidad','Tableros','Automáticos que saltan o fallas en diferenciales','2026-05-04 01:17:04');
...
INSERT INTO `clientes` VALUES (1,'Inmobiliaria Cordillera','76.123.456-K','contacto@cordillera.cl','+56911112222','Av. Las Condes 1234, Santiago','2026-05-04 01:17:04','Activo'),(2,'Retail Sudamérica S.A.','88.987.654-3','operaciones@retail.cl','+56223334444','Panamericana Norte km 15, Colina','2026-05-04 01:17:04','Activo');
...
INSERT INTO `evidencias` VALUES (1,1,'https://storage.pitagora.cl/evidencia/alerces_baño_antes.jpg','imagen','antes','2026-05-04 01:17:04'),(2,2,'https://storage.pitagora.cl/evidencia/alerces_cocina_golpe.jpg','imagen','antes','2026-05-04 01:17:04');
...
INSERT INTO `historial_bitacora` VALUES (1,1,4,'2026-05-04 01:17:04','Creación de observación','El cliente reporta filtración vía portal web',NULL,'2026-05-04 01:17:04'),(2,1,1,'2026-05-04 01:17:04','Cambio de estado a En Proceso','Se asigna cuadrilla técnica para el día lunes',NULL,'2026-05-04 01:17:04'),(3,2,1,'2026-05-04 01:17:04','Cambio de estado a No Aplica','Revisión técnica determina daño por mal uso','Se detectó que la cerámica fue golpeada con un objeto contundente ajeno a la construcción. Se adjuntan fotos de impacto.','2026-05-04 01:17:04');
...
INSERT INTO `mensajes` VALUES (1,1,2,'Ya coordinamos con el proveedor de grifería para el cambio de la pieza.','2026-05-04 01:17:04');
...
INSERT INTO `obras` VALUES (1,1,'Edificio Los Alerces','Edificio residencial 15 pisos','Calle Los Alerces 450, Ñuñoa','https://storage.pitagora.cl/planos/alerces.pdf','2025-10-15','2028-10-15','Activa','2026-05-04 01:17:04'),(2,2,'Centro Distribución Colina','Galpón industrial de 5000m2','Ruta 5 Norte, Colina','https://storage.pitagora.cl/planos/cd_colina.pdf','2026-01-20','2029-01-20','Activa','2026-05-04 01:17:04');
...
INSERT INTO `observaciones` VALUES (1,1,1,'Filtración de agua','Baño principal, debajo del vanitorio','Se observa goteo constante en la conexión del flexible de agua fría.','alta','en proceso','pendiente',NULL,NULL,'token_8822_xyz',0,'2026-05-04 01:17:04',NULL),(2,1,4,'Cerámica suelta','Cocina, muro norte','Dos cerámicas suenan huecas al tacto y el fragüe se está saliendo.','baja','no aplica','pendiente',NULL,NULL,'token_9933_abc',0,'2026-05-04 01:17:04',NULL);
...
INSERT INTO `tickets` VALUES (1,1,4,'2026-05-04 01:17:04','en proceso');
...
INSERT INTO `usuarios` VALUES (1,'Francisco Castillo','fcastillo@pitagora.cl','admin123','admin',NULL,'+56988887777','2026-05-04 01:17:04','Activo'),(2,'Juan Maestro','jmaestro@pitagora.cl','obra2026','jefe_obra',NULL,'+56955554444','2026-05-04 01:17:04','Activo'),(3,'Roberto Técnico','rtenico@pitagora.cl','tec2026','tecnico',NULL,'+56933332222','2026-05-04 01:17:04','Activo'),(4,'Admin Cordillera','admin@cordillera.cl','cli2026','cliente',1,'+56900001111','2026-05-04 01:17:04','Activo'),(5,'Pepe Tapia','pepetapia@dodo.com','oEPwxvJFVfP&','cliente',NULL,'912345678',NULL,'Inactivo'),(6,'pepe','apapa@papa.com','oEPwxvJFVfP&','cliente',NULL,'912345678',NULL,'Activo');
