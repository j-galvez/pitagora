    ...
    <div className="card mb-4 shadow-sm h-100 border-0">
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <span className="badge rounded-pill px-3 py-2" style={getStatusStyle(ticket.estado_general)}>
            {ticket.estado_general}
          </span>
        </div>

        <h6 className="text-secondary small">Obra</h6>
        <p className="mb-2">{ticket.obra?.nombre_obra || 'Obra asignada'}</p>

        <h6 className="text-secondary small mt-3">Fecha de Creación</h6>
        <p className="mb-3">{new Date(ticket.fecha_creacion).toLocaleDateString()}</p>
